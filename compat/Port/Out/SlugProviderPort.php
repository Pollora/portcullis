...
/*
 * 1.x name of {@see \Pollora\Portcullis\Port\Out\SlugProviderPort}.
 *
 ...
 *
 * @deprecated 2.0.0 Implement \Pollora\Portcullis\Port\Out\SlugProviderPort instead.
 */
class_alias(SlugProviderPort::class, __NAMESPACE__.'\SlugProviderPort');
