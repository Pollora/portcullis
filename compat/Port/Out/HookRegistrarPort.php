...
/*
 * 1.x name of {@see \Pollora\Portcullis\Port\Out\HookRegistrarPort}.
 *
 ...
 *
 * @deprecated 2.0.0 Implement \Pollora\Portcullis\Port\Out\HookRegistrarPort instead.
 */
class_alias(HookRegistrarPort::class, __NAMESPACE__.'\HookRegistrarPort');
